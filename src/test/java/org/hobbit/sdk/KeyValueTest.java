...
public class KeyValueTest {
    ...
    public void checkParsing() throws Exception {
        ...
        kv.setValue("property3", new String[]{ "value3", "value4" });
        KeyValue kv2 = new KeyValue();
        kv2.setValue("kv2.property1", "kv2.value1");
        kv.setValue("property4", kv2);
    ...
    @Test
    public void checkParsing2() throws JsonProcessingException {
