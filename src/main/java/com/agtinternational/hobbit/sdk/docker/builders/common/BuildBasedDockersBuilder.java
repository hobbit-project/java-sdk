...
public class BuildBasedDockersBuilder extends AbstractDockersBuilder {
    ...
    public BuildBasedDockersBuilder repoPath(String value){
        this.repoPath = value;
        return this;
    }
    ...
    public BuildBasedDockerizer build() throws Exception {
        ...
        if(repoPath!=null && !getImageName().startsWith(repoPath)) {
            imageName(Paths.get(repoPath, getImageName()).toString());
        }
